    ...
    <footer className="border-t py-8 bg-background">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            <Link to="/" className="flex items-center">
              <HealthAILogo size={32} withText={true} textColor="gradient" />
            </Link>
            <p className="mt-4 text-sm text-muted-foreground">
              Connect your health devices, analyze your data with Google AI, and find the right healthcare professional.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-muted-foreground">Email: support@googlehealthai.com</li>
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Google HealthAI. All rights reserved.</p>
          <div className="mt-2 flex justify-center space-x-4">
            ...
            <a href="#" className="text-xs hover:underline">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
